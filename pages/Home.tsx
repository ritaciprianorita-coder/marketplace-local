    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-400 rounded-3xl p-8 md:p-12 mb-12 text-white relative overflow-hidden shadow-xl">
        <div className="relative z-10 max-w-2xl">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Seja bem-vindo ao AcheiAqui</h2>
          <p className="text-lg opacity-90 mb-8">Produtos locais, artesanato único e serviços perto de você. Tudo o que você precisa em um só lugar.</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-grow">
              ...
              <input 
                ...
                placeholder="O que você precisa achar hoje?" 
                className="w-full pl-12 pr-4 py-4 rounded-xl text-gray-900 focus:outline-none focus:ring-4 focus:ring-orange-200"
              />
              {aiSuggestions.length > 0 && (
                <div className="absolute top-full left-0 right-0 bg-white shadow-2xl rounded-xl mt-2 overflow-hidden border border-gray-100 z-20">
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            Mostrando {filteredProducts.length} itens
          </div>
        </div>
